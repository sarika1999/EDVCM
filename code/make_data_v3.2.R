...
dat <- readRDS('~/Desktop/HARVARD/Dissertation/multinomial_GP/data/events_with_matched_controls_nolag_df_v3.rds')
...
#reformatted 
#saveRDS(dat2, "~/Desktop/events_with_matched_controls_nolag_df_v3.2.rds")

dat2 <- readRDS('~/Desktop/HARVARD/Dissertation/multinomial_GP/data/events_with_matched_controls_nolag_df_v3.2.rds')